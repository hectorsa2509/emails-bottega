...
with open(file) as f:
    ...
    for student in f_read:
        ...
        hour = s[2]
        to = s[0].split()
        body = 'Hi {0}! this is Hector from Bottega, just to remind you that tomorrow you have your mentoring session scheduled at {1} MST, if you want to reschedule please let us know sending an email to advisor@bottega.edu '.format(
            name, hour)
